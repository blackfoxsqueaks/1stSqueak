;(function () {
  ...
  function buildOrganizationSchema() {
    ...
    return JSON.stringify({
      ...
      "Oil change service Egypt",
      "Tire replacement Egypt",
      "Battery replacement Egypt",
      "Car diagnostics Egypt",
      "Engine diagnostics Egypt",
      "Car AC repair Egypt",
      "Brake pad replacement Egypt",
      "Wheel alignment and balancing",
      "Car painting and polishing Egypt",
      "Car cleaning at home",
      "Interior cleaning and sterilization",
      "Headlight restoration service",
      "Workshop locator app",
      "Auto service platform",
      "Automotive startups",
      "Automotive SaaS Egypt",
      "Garage management software",
      "Smart car services",
      "Custom car modification Egypt",
      "Pre-purchase car inspection",
      "Car underbody rustproofing",
      "Transmission repair Egypt",
      "Suspension and steering repair",
      "Used car inspection Egypt",
      "Car mechanic near me Egypt",
